...
%>
		<div>
			...
			<div class="d-flex border border-success p-3">
				<img src="<%=music.get("thumbnail")%>" alt="앨범이미지" width="150px">
				<div class="ml-3">
					<div class="name2"><%=music.get("title")%></div>
					<div class="font-weight-bold text-success"><%=music.get("singer")%></div>
					<div>
						<table class="mt-2">
							<tr>
								<td class="text-dark">앨범</td>
								<td><%=music.get("album")%></td>
							</tr>
							<tr>
								<td class="text-dark">재생시간</td>
								<%
								int m = (int) music.get("time") / 60;
								int s = (int) music.get("time") % 60;
								%>
								<td><%=m%> : <%=s%></td>
							</tr>
							<tr>
								<td class="text-dark">작곡가</td>
								<td><%=music.get("composer")%></td>
							</tr>
							<tr>
								<td class="text-dark">작사가</td>

...
<div class="border border-success p-3 d-flex">
	<img alt="프로필 사진" src="<%=artistInfo.get("photo")%>" width="150px">
	<div class="ml-3">
...
<div>
	<h4 class="mt-2 font-weight-bold">곡 목록</h4>
</div>
<table class="table text-center">
	...
	<tbody>
		...
		<tr>
			<td><%=music.get("id")%></td>
			<td><a href="/lesson03/quiz02/template2.jsp?no=<%=music.get("id")%>"><%=music.get("title")%></a></td>

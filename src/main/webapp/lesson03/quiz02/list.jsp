...
<div class="d-flex border border-success p-3">
	...
	<div class="ml-3">
		<div class="name font-weight-bold"><%=artistInfo.get("name")%></div>
		<div><%=artistInfo.get("agency")%></div>
		<div><%=artistInfo.get("debute")%>년 데뷔
		</div>
	</div>
</div>
...
<div>
	...
	<table class="table text-center">
		...
		<tbody>
			...
			<tr>
				<td><%=music.get("id")%></td>
				<td><a href="info_template.jsp?title=<%=music.get("title")%>"><%=music.get("title")%></a></td>
